  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ContactListBloc, ContactListState>(
      builder: (context, state) {
        ...
        const int maxActiveContacts = 18; // Use the fixed number 18
        ...
        if (state is LoadingContactListState || state is InitialContactListState) {
          ...
          currentActiveContacts = state.originalContacts.where((contact) => contact.isActive).length;

          if (state.isSelectionMode && state.selectedContacts.isNotEmpty) {
            screenTitleText = 'Active ($currentActiveContacts / $maxActiveContacts)';
            if (currentActiveContacts > maxActiveContacts) {
          ...
          screenTitleText = 'Active (0 / $maxActiveContacts)';
          currentActiveContacts = 0;
        }
        ...
        return BaseContactListScaffold(
          ...
          activeContactCount: currentActiveContacts, // Pass current active count
          maxActiveContacts: maxActiveContacts, // Pass max active contacts
