...
// in recall/test/repositories/contact_repository_test.dart.
...
class MockStore extends _i1.Mock implements _i5.Store {
  MockStore() {
  ...
  _i3.Future<R> runInTransactionAsync<R, P>(
    _i8.TxMode? mode,
    _i5.TxAsyncCallback<R, P>? callback,
    P? param,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  _i3.Future<R> runAsync<P, R>(
    _i5.RunAsyncCallback<P, R>? callback,
    P? param,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
...
class MockBox<T> extends _i1.Mock implements _i2.Box<T> {
  ...
  @override
  _i3.Future<T?> getAsync(int? id) => (super.noSuchMethod(
        Invocation.method(
          #getAsync,
          [id],
        ),
  ...
  @override
  _i3.Future<List<T>> getAllAsync() => (super.noSuchMethod(
        Invocation.method(
          #getAllAsync,
          [],
        ),
  ...
  @override
  _i4.QueryBuilder<T> query([_i4.Condition<T>? qc]) => (super.noSuchMethod(
        Invocation.method(
          #query,
          [qc],
        ),
        returnValue: _FakeQueryBuilder_2<T>(
          this,
          Invocation.method(
            #query,
            [qc],
...
class MockQuery<T> extends _i1.Mock implements _i4.Query<T> {
  ...
  @override
  _i3.Future<T?> findFirstAsync() => (super.noSuchMethod(
        Invocation.method(
          #findFirstAsync,
          [],
        ),
  ...
  @override
  _i3.Future<T?> findUniqueAsync() => (super.noSuchMethod(
        Invocation.method(
          #findUniqueAsync,
          [],
        ),
  ...
  @override
  _i3.Future<List<T>> findAsync() => (super.noSuchMethod(
        Invocation.method(
          #findAsync,
          [],
        ),
  ...
  @override
  List<_i9.IdWithScore> findIdsWithScores() => (super.noSuchMethod(
        Invocation.method(
          #findIdsWithScores,
          [],
        ),
  ...
  _i3.Future<List<_i9.IdWithScore>> findIdsWithScoresAsync() =>
      (super.noSuchMethod(
        ...
        returnValue:
            _i3.Future<List<_i9.IdWithScore>>.value(<_i9.IdWithScore>[]),
      ) as _i3.Future<List<_i9.IdWithScore>>);

  @override
  List<_i9.ObjectWithScore<T>> findWithScores() => (super.noSuchMethod(
        Invocation.method(
          #findWithScores,
          [],
        ),
  ...
  @override
  _i3.Stream<T> stream() => (super.noSuchMethod(
        Invocation.method(
          #stream,
          [],
        ),
